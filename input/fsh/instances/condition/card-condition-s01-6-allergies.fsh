...
* code.coding[0] = $chmed-codesystem-risks-cdscode#555 "Betablocker-Allergie (Propranolol-Typ)"
* code.coding[+] = $chmed-codesystem-risks-cdscode#571 "Penicillin-Allergie"
