...
* dosageInstruction[baseEntry].timing.repeat.boundsPeriod.start = "2016-09-12"
* dosageInstruction[baseEntry].timing.repeat.boundsPeriod.end = "2020-09-12"
...
* dosageInstruction[baseEntry].doseAndRate.doseQuantity = 1 '{Piece}' "Piece"
