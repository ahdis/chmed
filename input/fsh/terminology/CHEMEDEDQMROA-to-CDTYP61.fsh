Instance: CHEMEDEDQMROA-to-CDTYP61
...
* name = "EDQMROAMap"
* title = "CH EMED EDQM RouteOfAdministration to CDTYP61"
* status = #active
* description = "Mapping to describe the relationships between CH EMED EDQM RouteOfAdministration and CDTYP61"

* sourceUri = "http://fhir.ch/ig/ch-emed/ValueSet/edqm-routeofadministration"

// EDQM Standard Terms
* group[+].source = "urn:oid:0.4.0.127.0.16.1.1.2.1"
* group[=].target[+] = "http://chmed.emediplan.ch/fhir/CodeSystem/chmed-codesystem-cdtyp61"
